...
{
    public sealed class FileLoadNotificationOutboxMessage
    {
        ...
        private FileLoadNotificationOutboxMessage()
        {
        }

        public FileLoadNotificationOutboxMessage(long fileLoadId)
        {
            if (fileLoadId <= 0)
            {
